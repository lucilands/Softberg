			...
			switch(e.type) {
				...
				case SDL_KEYDOWN: {
					switch (e.key.keysym.sym) {
						case SDLK_l: depth_screen = !depth_screen; break;
						case SDLK_c: interpolate_colors = !interpolate_colors; break;
						case SDLK_q: running = false; break;

						case SDLK_w: transform.rotation.y += ROTATION_SPEED*delta_time; break;
						case SDLK_s: transform.rotation.y -= ROTATION_SPEED*delta_time; break;
						case SDLK_d: transform.rotation.x += ROTATION_SPEED*delta_time; break;
						case SDLK_a: transform.rotation.x -= ROTATION_SPEED*delta_time; break;
						default:break;
					}
					break;
				}
